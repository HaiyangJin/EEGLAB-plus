...
% 00 DivEpo
condSavePath = strcat(filePath, '04_DivEpo_manual/');

%% load PreProcessed files 
% the filename of PreProcessed data
preProcessedName = strcat(participantName, '_03_PreProcessed_*','.set');
preProcessedFolder = '03_PreProcessed_1000_manully';
